...
namespace PrismSample.Lib.Models.NPOI
{
    ...
    {
        private static ExportExcelFiles instance;

        public static ExportExcelFiles Instance { get { if (instance == null) instance = new ExportExcelFiles(); return instance; } set => instance = value; }
        private ExportExcelFiles() { }
        ...
        public void ExportExcelFileWithNPOI(string @output, List<DataBinding.DataHeaderExcel> dataHeaderExcels, List<DataBinding.DataBodyExcelFile> dataBodyExcelFiles)
        {
            ...
            //set font horizontal
            SetFontHorizontalVertical.Instance.SetCellFontMultiRow(wb, sheet, 4, 4, 2, 2, "horizontalLeft");
            //set cell style
            ...
            SetFontHorizontalVertical.Instance.SetCellFontMultiRow(wb, sheet, 12, rowIndex - 1, 4, 5, "horizontalLeft");
